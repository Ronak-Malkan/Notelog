    ...
    <body>
        ...
        <div class="note">
            <form action="saveNote" method="post" id="enterNote">
                <textarea class="title" cols="20" rows="1" required="required" name="title" placeholder="Enter Title" spellcheck="false"></textarea>
                <textarea class="date" cols="12" rows="1" required="required" name="date" placeholder="Enter Date" spellcheck="false"></textarea><br><br>
