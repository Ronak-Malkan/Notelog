    ...
    <body style="background-color: var(--color3);">
        ...
        <div class="note">
            <form action="edit" method="post">
                <textarea class="title" cols="26" rows="1" required="required" name="title" spellcheck="false"><%out.print(rs.getString("title"));%></textarea>
                <textarea class="date" cols="14" rows="1" required="required" name="date" spellcheck="false"><%out.print(rs.getString("date"));%></textarea><br><br>
